...
def update_preferences():
    ...
    try:
        ...
        if selected_prefs:
            ...
            flash(
                f"Preferences updated! You'll now see {prefs_text} recommendations on your dashboard. 🍔",
                "success",
            )
        else:
            flash(
                "Preferences cleared! You'll see our top picks on your dashboard. 🍔",
                "success",
            )

        return redirect(
            url_for("auth.dashboard")
        )  # Redirect to dashboard to see new recommendations
