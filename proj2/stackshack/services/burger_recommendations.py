...
class BurgerRecommendationService:
    ...
    def get_recommendations_for_user(user):
        ...
        if 'vegan' in preferences and 'gluten_free' in preferences:
            return BurgerRecommendationService._get_vegan_gf_recommendations(preferences)
        ...
        return BurgerRecommendationService._get_multi_preference_recommendations(preferences)
    ...
    def _get_vegan_gf_recommendations(all_preferences):
        ...
        for burger in PREDEFINED_BURGERS:
            if 'vegan' in burger['dietary_tags'] and 'gluten_free' in burger['dietary_tags']:
