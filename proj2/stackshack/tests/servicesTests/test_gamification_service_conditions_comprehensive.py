...
class TestGamificationServiceConditionsComprehensive:
    ...
    def test_check_keto_bun(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Keto Bun", category="bun", price=Decimal("2.00"), is_available=True)
            db.session.add(bun)
            db.session.flush()
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Keto Bun", price=Decimal("2.00"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_sesame_bun(self, app, test_user):
        ...
        with app.app_context():
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Sesame Bun", price=Decimal("1.50"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_black_sesame_bun(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Black Sesame Bun", category="bun", price=Decimal("2.00"), is_available=True)
            db.session.add(bun)
            db.session.flush()
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Black Sesame Bun", price=Decimal("2.00"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_veggie_bun(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Beetroot Bun", category="bun", price=Decimal("2.00"), is_available=True)
            db.session.add(bun)
            db.session.flush()
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Beetroot Bun", price=Decimal("2.00"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_wheat_bun(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Wheat Bun", category="bun", price=Decimal("1.50"), is_available=True)
            db.session.add(bun)
            db.session.flush()
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Wheat Bun", price=Decimal("1.50"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_plain_bun(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Plain Bun", category="bun", price=Decimal("1.00"), is_available=True)
            db.session.add(bun)
            db.session.flush()
            ...
            item = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Plain Bun", price=Decimal("1.00"), quantity=1)
            db.session.add(item)
            db.session.commit()
    ...
    def test_check_two_cheeses(self, app, test_user):
        ...
        with app.app_context():
            cheese1 = MenuItem(name="Cheddar Cheese", category="cheese", price=Decimal("1.00"), is_available=True)
            cheese2 = MenuItem(name="Swiss Cheese", category="cheese", price=Decimal("1.00"), is_available=True)
            ...
            item1 = OrderItem(order_id=order.id, menu_item_id=cheese1.id, name="Cheddar Cheese", price=Decimal("1.00"), quantity=1)
            item2 = OrderItem(order_id=order.id, menu_item_id=cheese2.id, name="Swiss Cheese", price=Decimal("1.00"), quantity=1)
    ...
    def test_check_all_healthy(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Keto Bun", category="bun", price=Decimal("2.00"), is_available=True, is_healthy_choice=True)
            patty = MenuItem(name="Mixed Veg Patty", category="patty", price=Decimal("3.00"), is_available=True, is_healthy_choice=True)
            ...
            item1 = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Keto Bun", price=Decimal("2.00"), quantity=1)
            item2 = OrderItem(order_id=order.id, menu_item_id=patty.id, name="Mixed Veg Patty", price=Decimal("3.00"), quantity=1)
            db.session.add_all([item1, item2])
            db.session.commit()
    ...
    def test_check_all_healthy_false(self, app, test_user):
        ...
        with app.app_context():
            bun = MenuItem(name="Keto Bun", category="bun", price=Decimal("2.00"), is_available=True, is_healthy_choice=True)
            patty = MenuItem(name="Beef Patty", category="patty", price=Decimal("3.00"), is_available=True, is_healthy_choice=False)
            db.session.add_all([bun, patty])
            db.session.flush()
            ...
            item1 = OrderItem(order_id=order.id, menu_item_id=bun.id, name="Keto Bun", price=Decimal("2.00"), quantity=1)
            item2 = OrderItem(order_id=order.id, menu_item_id=patty.id, name="Beef Patty", price=Decimal("3.00"), quantity=1)
            db.session.add_all([item1, item2])
            db.session.commit()
    ...
    def test_check_three_toppings(self, app, test_user):
        ...
        with app.app_context():
            top1 = MenuItem(name="Lettuce", category="topping", price=Decimal("0.50"), is_available=True)
            top2 = MenuItem(name="Tomato", category="topping", price=Decimal("0.50"), is_available=True)
            top3 = MenuItem(name="Onion", category="topping", price=Decimal("0.50"), is_available=True)
            ...
            item1 = OrderItem(order_id=order.id, menu_item_id=top1.id, name="Lettuce", price=Decimal("0.50"), quantity=1)
            item2 = OrderItem(order_id=order.id, menu_item_id=top2.id, name="Tomato", price=Decimal("0.50"), quantity=1)
            item3 = OrderItem(order_id=order.id, menu_item_id=top3.id, name="Onion", price=Decimal("0.50"), quantity=1)
    ...
    def test_check_all_toppings(self, app, test_user):
        ...
        with app.app_context():
            toppings = [
                ...
                MenuItem(name="Onion", category="topping", price=Decimal("0.50"), is_available=True),
                MenuItem(name="Pickles", category="topping", price=Decimal("0.50"), is_available=True),
                MenuItem(name="Capsicum", category="topping", price=Decimal("0.50"), is_available=True),
            ]
            ...
            items = [OrderItem(order_id=order.id, menu_item_id=t.id, name=t.name, price=t.price, quantity=1) for t in toppings]
    ...
    def test_check_two_sauces(self, app, test_user):
        ...
        with app.app_context():
            sauce1 = MenuItem(name="Ketchup", category="sauce", price=Decimal("0.25"), is_available=True)
            sauce2 = MenuItem(name="Mayo", category="sauce", price=Decimal("0.25"), is_available=True)
            ...
            item1 = OrderItem(order_id=order.id, menu_item_id=sauce1.id, name="Ketchup", price=Decimal("0.25"), quantity=1)
            item2 = OrderItem(order_id=order.id, menu_item_id=sauce2.id, name="Mayo", price=Decimal("0.25"), quantity=1)
            db.session.add_all([item1, item2])
            db.session.commit()
