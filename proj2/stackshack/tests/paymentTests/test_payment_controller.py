...
class TestPaymentController:
    ...
    def test_process_payment_order_not_found(self, app, test_user):
        ...
        with app.app_context():
            payment_data = {"order_id": 99999, "user_id": test_user, "amount": 15.00}

            success, message, transaction_data = PaymentController.process_payment(
                payment_data
            )
    ...
    def test_process_payment_already_paid(
        self, mock_gateway, app, test_user, sample_order
    ):
