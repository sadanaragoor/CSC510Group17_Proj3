...
class TestPaymentRoutesErrorPaths:
    ...
    def test_process_balance_addition_invalid_amount_string(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            campus_card = CampusCard(user_id=test_user, card_number="1234567890", balance=Decimal("50.00"))
