...
from models.gamification import PointsTransaction, Badge, UserBadge, DailyBonus, WeeklyChallenge, Coupon, Redemption
...
class TestGamificationRoutesComprehensive:
    ...
    def test_api_weekly_challenge_multiple(self, client, app, test_user):
        ...
        assert "challenges" in data or "weekly_challenges" in data or isinstance(data, list)
