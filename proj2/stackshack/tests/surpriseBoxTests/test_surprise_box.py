...
class TestSurpriseBoxRoutes:
    ...
    def test_surprise_box_authenticated(self, client, app, test_user, sample_menu_items):
    ...
    def test_surprise_box_returns_burger(self, client, app, test_user, sample_menu_items):
    ...
    def test_surprise_box_respects_vegan_preference(self, client, app, vegan_user, sample_menu_items):
    ...
    def test_surprise_box_multiple_toppings(self, client, app, test_user, sample_menu_items):
    ...
    def test_surprise_box_multiple_sauces(self, client, app, test_user, sample_menu_items):
    ...
    def test_surprise_box_different_each_time(self, client, app, test_user, sample_menu_items):
