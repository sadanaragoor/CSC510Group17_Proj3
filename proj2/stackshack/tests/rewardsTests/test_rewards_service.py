...
class TestPointsSystem:
    ...
    def test_get_user_points_with_redemption(self, app, test_user):
        ...
        with app.app_context():
            ...
            # Redeem points
            GamificationService.earn_points("redemption", test_user, -100, "Redeemed reward")
...
class TestTierSystem:
    ...
    def test_update_tier_gold(self, app, test_user):
        ...
        with app.app_context():
            ...
            GamificationService.earn_points("purchase", test_user, 1501, "Very large order")
...
class TestCouponValidation:
    ...
    def test_validate_coupon_wrong_user(self, app, test_user, silver_user, sample_order):
